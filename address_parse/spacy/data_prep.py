...
df_train=pd.read_csv(filepath_or_buffer="address_parse/spacy/corpus/dataset/train.csv",sep=",",dtype=str)
...
doc_bin_train.to_disk("address_parse/spacy/corpus/spacy-docbins/train.spacy")
######################################


###### Validation dataset prep ###########
# Read the validation dataset into pandas
df_test=pd.read_csv(filepath_or_buffer="address_parse/spacy/corpus/dataset/test.csv",sep=",",dtype=str)
...
doc_bin_test.to_disk("address_parse/spacy/corpus/spacy-docbins/test.spacy")
##########################################